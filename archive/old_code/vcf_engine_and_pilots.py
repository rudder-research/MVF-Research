...
write(analysis + "/run_pilot_001.py", [
    "import numpy as np",
    "import pandas as pd",
    "from vcf.core.normalize import zscore",
    "from vcf.core.magnitude import rowwise_magnitude",
    "from vcf.core.state_space import assemble_state",
    "",
    "def demo():",
...
write(analysis + "/run_pilot_003.py", [
    "import pandas as pd",
    "from pathlib import Path",
    "from vcf.core.normalize import zscore, minmax",
    "",
